...
public:
    ...
    //Below are helper functions to retrive the data present in resp image filters
    static SkMatrix getTransformFromFilter(SkImageFilter* filter);
    static SkScalar getBlurFromFilter(SkImageFilter* filter);
    static SkColor getColorFromColorFilter(SkImageFilter* filter);
    static SkColor getColorFromColorMatrixFilter(SkImageFilter* filter); 
