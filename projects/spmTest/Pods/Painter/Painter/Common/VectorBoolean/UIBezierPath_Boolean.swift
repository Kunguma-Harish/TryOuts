...
public extension CGPath {
	...
	func fb_union(_ path: CGPath) -> CGPath {
	...
	func fb_intersect(_ path: CGPath) -> CGPath {
		let thisGraph = FBBezierGraph(path: self)
		let otherGraph = FBBezierGraph(path: path)
		let result = thisGraph.intersectWithBezierGraph(otherGraph).cgPath
		//    result.fb_copyAttributesFrom(self)
		return result
	}
	...
	func fb_difference(_ path: CGPath) -> CGPath {
		let thisGraph = FBBezierGraph(path: self)
		let otherGraph = FBBezierGraph(path: path)
		let result = thisGraph.differenceWithBezierGraph(otherGraph).cgPath
		//    result.fb_copyAttributesFrom(self)
		return result
	}
	...
	func fb_xor(_ path: CGPath) -> CGPath {
		let thisGraph = FBBezierGraph(path: self)
		let otherGraph = FBBezierGraph(path: path)
		let result = thisGraph.xorWithBezierGraph(otherGraph).cgPath
		//    result.fb_copyAttributesFrom(self)
		return result
	}
}
