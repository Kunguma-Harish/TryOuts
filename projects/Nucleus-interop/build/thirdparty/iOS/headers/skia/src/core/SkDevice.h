...
public:
    ...
    */
    ...
    // to faciliate group filters to be added under saveLayer to resp backedn device
    virtual void onRestore() {}
    virtual void onLayerRestore() {}
    virtual void onSaveLayer() {}
    virtual void onSaveLayer(SkPaint*) {}
