...
SkShader* SkShaderBase::getSourceShader() { 
    return ((SkBlendShader*)(this))->getSourceShader(); 
}

SkShader* SkShaderBase::getDestinationShader() { 
    return ((SkBlendShader*)(this))->getDestinationShader(); 
}
