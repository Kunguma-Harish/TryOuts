...
extension PieChart: @unchecked Sendable {}
...
extension PieChart: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PieChart"
  ...
  public static func ==(lhs: PieChart, rhs: PieChart) -> Bool {
