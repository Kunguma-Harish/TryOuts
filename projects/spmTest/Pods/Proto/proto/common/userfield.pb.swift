...
extension UserField: @unchecked Sendable {}
...
extension UserField: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UserField"
  ...
  public static func ==(lhs: UserField, rhs: UserField) -> Bool {
