...
public:
    ...
    //to be set from app-side
    void setBounds(SkRect);
    ...
    // to extract propertied needed to generate filters

    static std::shared_ptr<shadowAttributes> extractOuterShadowAttributes(SkImageFilter*);

    static std::shared_ptr<shadowAttributes> extractInnerShadowAttributes(SkImageFilter*);

    static std::shared_ptr<shadowAttributes> extractBlurAttributes(SkImageFilter* imagefilter);

    static SkImageFilter::shadowAttributes ExtractDropShadowParams(SkImageFilter* compositeFilter);

    static bool isDropShadowFilter(SkImageFilter* filter);

    static bool isInnerShadowFilter(SkImageFilter* filter);
