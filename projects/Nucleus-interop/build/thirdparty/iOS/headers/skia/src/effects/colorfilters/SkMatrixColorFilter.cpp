...
const float* SkColorFilterBase::getColorMatrix(SkColorFilter* filter) {
    SkMatrixColorFilter* colorFilterImageFilter = ((SkMatrixColorFilter*)as_CFB(filter));
    return colorFilterImageFilter->matrix();
}
