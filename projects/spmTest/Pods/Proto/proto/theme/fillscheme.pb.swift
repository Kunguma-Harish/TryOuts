...
public struct FillScheme {
  ...
  /// As of now , we have 3 values in it.	
...
extension FillScheme: @unchecked Sendable {}
...
extension FillScheme: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".FillScheme"
  ...
  public var isInitialized: Bool {
    ...
    if !SwiftProtobuf.Internal.areAllInitialized(self.fill) {return false}
    return true
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.fill) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.fill.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.fill, fieldNumber: 3)
    }
  ...
  public static func ==(lhs: FillScheme, rhs: FillScheme) -> Bool {
