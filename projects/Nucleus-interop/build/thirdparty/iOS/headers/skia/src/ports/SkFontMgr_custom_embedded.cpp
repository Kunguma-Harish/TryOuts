...
void SkFontMgr_Custom_Data_Add_Fonts(SkFontMgr_Custom* customFontMgr, sk_sp<SkData>* datas, int n) {
    SkASSERT(customFontMgr != nullptr);
    SkASSERT(datas != nullptr);
    SkASSERT(n > 0);
    customFontMgr->addFonts(DataFontLoader(datas, n));
}