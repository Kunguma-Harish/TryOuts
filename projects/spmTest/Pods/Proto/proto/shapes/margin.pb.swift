...
public struct Margin {
  ...
  /// All four values are in px. All px values will be modified according to the screen size. 
...
extension Margin: @unchecked Sendable {}
...
extension Margin: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Margin"
