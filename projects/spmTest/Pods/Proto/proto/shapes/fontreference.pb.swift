...
extension FontReference: @unchecked Sendable {}
...
extension FontReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".FontReference"
  ...
  public static func ==(lhs: FontReference, rhs: FontReference) -> Bool {
