...
public struct Marker {
  ...
  /// marker type
  public var type: StrokeField.MarkerType {
  ...
  public var width: StrokeField.Size {
    get {return _width ?? .medium}
    set {_width = newValue}
  }
  ...
  /// marker height 
  public var height: StrokeField.Size {
    get {return _height ?? .medium}
  ...
  fileprivate var _type: StrokeField.MarkerType? = nil
  fileprivate var _width: StrokeField.Size? = nil
  fileprivate var _height: StrokeField.Size? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Marker: @unchecked Sendable {}
...
extension Marker: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularEnumField(value: &self._width) }()
      case 3: try { try decoder.decodeSingularEnumField(value: &self._height) }()
      default: break
      }
    }
  }
