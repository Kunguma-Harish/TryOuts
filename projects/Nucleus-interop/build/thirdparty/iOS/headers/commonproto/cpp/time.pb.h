...
class Time final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.zoho.common.Time) */ {
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:com.zoho.common.Time)
 private:
  class _Internal;
...
inline ::int64_t Time::seconds() const {
  // @@protoc_insertion_point(field_get:com.zoho.common.Time.seconds)
  return _internal_seconds();
}
inline void Time::set_seconds(::int64_t value) {
  _internal_set_seconds(value);
  // @@protoc_insertion_point(field_set:com.zoho.common.Time.seconds)
}
