...
public:
    ...
    SkScalar getBlur() { return SkSize(fSigma).width(); }
...
SkScalar SkImageFilter_Base::getBlurFromFilter(SkImageFilter* filter) {
    return ((SkBlurImageFilter*)as_IFB(filter))->getBlur();
