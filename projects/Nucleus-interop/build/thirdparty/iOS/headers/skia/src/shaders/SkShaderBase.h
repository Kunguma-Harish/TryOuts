...
#undef M
    ...
    bool replaceShaderProps(sk_sp<SkShader> shader);
    virtual bool onReplaceShaderProps(sk_sp<SkShader> shader);
    ...
    SkShader* getSourceShader();

    SkShader* getDestinationShader();

    SkColor getShaderColor();
