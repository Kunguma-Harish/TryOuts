...
extension FontScheme: @unchecked Sendable {}
...
extension FontScheme: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".FontScheme"
  ...
  public var isInitialized: Bool {
    ...
    if !SwiftProtobuf.Internal.areAllInitialized(self.latin) {return false}
    return true
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.latin) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.latin.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.latin, fieldNumber: 3)
    }
  ...
  public static func ==(lhs: FontScheme, rhs: FontScheme) -> Bool {
    if lhs._id != rhs._id {return false}
    if lhs._name != rhs._name {return false}
    if lhs.latin != rhs.latin {return false}
