...
public:
    ...
    SkMatrix getTransform() { return SkMatrix(fTransform); }
...
SkMatrix SkImageFilter_Base::getTransformFromFilter(SkImageFilter* filter) {
    return (((SkMatrixTransformImageFilter*)as_IFB(filter))->getTransform());
}
