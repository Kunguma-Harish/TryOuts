...
bool SkShader::replaceShaderProps(sk_sp<SkShader> shader) {
    return as_SB(this)->replaceShaderProps(shader);
}

bool SkShaderBase::replaceShaderProps(sk_sp<SkShader> shader) {
    return onReplaceShaderProps(shader);
}

bool SkShaderBase::onReplaceShaderProps(sk_sp<SkShader> shader) {
    SK_ABORT("onReplaceShaderProps should be used only on shaders created from SkImage");
    return false;
}
